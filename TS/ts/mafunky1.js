...
function OptimizeAjax() {
    //	priorPrefilter
    jQuery.ajaxPrefilter(function (A7U, n7U, xhr) {
...
function avactor() {
    ...
    function errorgo_(j_) {
        ...
        var d_ = "#" + b_ + " div";
        /** @type {string} */
        var errormsgs_ = "<tr ID = \"" + b_ + "\"><td><div class = \"errBR\">" + j_ + "<div></td></tr>";
    ...
    setTimeout(function () {
                ...
                setTimeout(function () {
                    ...
                    $("#addcity").click(function () {
                        ...
                        $("#addadd").click(function () {
                            var tempx_10 = $("#addx").val();
                            var tempy_10 = $("#addy").val();
                            /** @type {number} */
        ...
        cotgsubscribe.subscribe("regional", function (clickInfo) {
            ...
            if (dtype_ === "dungeon") {
                ...
                for (var i in troops) {
                    ...
                    var home_1 = d.home;
                    /** @type {number} */
                    home_loot_2_1 = home_loot_2_1 + home_1 * ttloot_[TroopNameToId(i)];
                }
                if (type_113 === "Siren's Cove") {
                     ...
                     * @return {void}
                     */
                    var total_lootm_1 = Math.ceil(loot_[AsNumber(lvl_) - 1] * (1 - AsNumber(prog_) / 100 + 1) * 1.05);
                    document.getElementById("raidDungGo").onclick = function () {
                        setTimeout(function () {
                            /** @type {number} */
                            if (home_loot_2_1 > total_lootm_1) {
                                /** @type {number} */
                                var option_numbersm_ = Math.floor(home_loot_2_1 / total_lootm_1);
                                /** @type {number} */
                                var templ1m_ = home_loot_2_1 / total_lootm_1 * 100 / option_numbersm_;
                                /** @type {number} */
                                var templ2m_ = (templ1m_ - 100) / templ1m_ * 100;
                                /** @type {number} */
                                for (var i in troops) {
                                    var id = TroopNameToId(i);
                                    var th = troops[i].home;
                                    /** @type {number} */
                ...
                var _cid = AsNumber(clickInfo.x) + 65536 * AsNumber(clickInfo.y);
                var toAdd = __assign({}, defaultMru); // clone defaults
                var isCity = (dtype_ === "city");
                //var maxCount = 32;
                ///** @type {AsNumber} */
            ...
            if ($("#cancelAllya").prop("checked") == false) {
                setTimeout(function () {
                    $(".shAinf").each(function () {
                        var tid_7 = ToInt($(this).parent().next().find(".cityblink").attr("data"));
                        /** @type {number} */
                    ...
                    $(".shPinf").each(function () {
                        var a = $(this).parent().next().find(".cityblink");
                        var tid_8 = GetIntData(a);
                        /** @type {number} */
        ...
        $("#siegeGo").click(function () {
            if ($("#cancelAllys").prop("checked") == false) {
                setTimeout(function () {
                    ...
                    $(".shPinf").each(function () {
                        var cid = GetCidData($(this).parent().next().find(".cityblink"));
                        /** @type {number} */
                        var tx_8 = cid.x;
                        /** @type {number} */
                        var ty_8 = cid.y;
                ...
                $("#funkylayoutw").change(function () {
                    ...
                    for (; j_13 < layoutsw_.length; j_13++) {
                        if ($("#funkylayoutw").val() == j_13) {
                            /** @type {number} */
                            for (var i_55 = 20; i_55 < currentlayout_.length; i_55++) {
                            ...
                            if ($("#addhub").prop("checked") == true) {
                                ...
                                $.each(ppdt.clc, function (key_57, value_105) {
                                    if (key_57 == $("#selHub").val()) {
                                        /** @type {number} */
                                        hubs_3.cid = value_105;
                                    }
                                });
                                for (var i_55 in hubs_3.cid) {
                                    /** @type {number} */
                ...
                $("#dfunkylayout").change(function () {
                    ...
                    for (; j_14 < layoutdf_.length; j_14++) {
                        if ($("#dfunkylayout").val() == j_14) {
                            /** @type {number} */
                            for (var i_56 = 20; i_56 < currentlayout_.length; i_56++) {
                            ...
                            if ($("#addhub").prop("checked") == true) {
                                ...
                                $.each(ppdt.clc, function (key_58, value_106) {
                                    if (key_58 == $("#selHub").val()) {
                                        /** @type {number} */
                                        hubs_4.cid = value_106;
                                    }
                                });
                                for (var i_56 in hubs_4.cid) {
                                    /** @type {number} */
...
//# sourceMappingURL=mafunky1.js.map
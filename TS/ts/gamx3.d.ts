...
declare let setcitybind: any;
declare function gaFrep(E7c: any): void;
declare class CotgTroopCount {
    total: number;
    home: number;
}
declare class CotgTroops {
    galley: CotgTroopCount;
    ram: CotgTroopCount;
    triari: CotgTroopCount;
    arbalist: CotgTroopCount;
    horseman: CotgTroopCount;
    scorpion: CotgTroopCount;
    sorcerer: CotgTroopCount;
    senator: CotgTroopCount;
    ballista: CotgTroopCount;
    stinger: CotgTroopCount;
    vanquisher: CotgTroopCount;
    priestess: CotgTroopCount;
    ranger: CotgTroopCount;
    scout: CotgTroopCount;
    guard: CotgTroopCount;
    praetor: CotgTroopCount;
    druid: CotgTroopCount;
    warship: CotgTroopCount;
}
declare abstract class CtogCity {
    abstract troops(): CotgTroops;
    abstract id(): number;
}
interface Alliance {
    name(): string;

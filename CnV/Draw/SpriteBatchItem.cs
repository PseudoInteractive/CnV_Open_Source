...
using Microsoft.Xna;
using VertexSprite = Microsoft.Xna.VertexSprite;
namespace CnV
{
	public class Mesh
	{
	...
	{
		//public static void Set(this VertexSprite me, float x, float y, float dx, float dy, float w, float h, float sin, float cos, Color color, Vector2 texCoordTL, Vector2 texCoordBR, float depth)
		//{
		...
		//public static void Set(this  VertexSprite me, float x0, float y0, float x1, float y1, Color color, Vector2 texCoordTL, Vector2 texCoordBR, float depthBase, DepthFunction depth)
		//{
		...
		//public static void Set(this VertexSprite me, float x0, float y0, float x1, float y1, Color color, Vector2 texCoordTL, Vector2 texCoordBR, float depthTL, float depthTR, float depthBL, float depthBR)
		//{
		//	me.vertexTL.Position.X = x0;
		//	me.vertexTL.Position.Y = y0;
		...
		//	me.vertexBR.TextureCoordinate.Y = texCoordBR.Y;
		//}
		//public static void Set(this Microsoft.Xna.VertexSprite me, float x0, float y0, float x1, float y1, Color color, Vector2 texCoordTL, Vector2 texCoordBR, float depth)
		//{
		//	me.vertexTL.Position.X = x0;
		//	me.vertexTL.Position.Y = y0;
		//	me.vertexTL.Position.Z = depth;
		...
		//	me.vertexBR.TextureCoordinate.Y = texCoordBR.Y;
		//}
		//public static void Set(this Microsoft.Xna.VertexSprite me, float x0, float y0, float x1, float y1, Color colorTL, Color colorTR,Color colorBL,Color colorBR, Vector2 texCoordTL, Vector2 texCoordBR, float depth)
		//{
		//	me.vertexTL.Position.X = x0;
		//	me.vertexTL.Position.Y = y0;
		//	me.vertexTL.Position.Z = depth;

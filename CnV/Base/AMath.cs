...
namespace COTG;
    ...
    public static partial class AMath
	{
		...
		public static int Cross(this (int X, int Y) v0, (int X, int Y) v1)
		{
			return (v0.X * v1.Y) - (v0.Y * v1.X);
		}
		public static (int X,int Y) Sub(this (int X, int Y) v1, (int X, int Y) v0)
		{

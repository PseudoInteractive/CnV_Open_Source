...
namespace COTG.Game
{
    public static class Enum
    {
        ...
        public static string[] troop = { "guard", "ballista", "ranger", "triari", "priestess", "vanquisher", "sorcerers", "scout", "arbalist", "praetor", "horseman", "druid", "ram", "scorpion", "galley", "stinger", "warship", "senator" };
        ...
        public static short[]  ttattack_ = { 10, 50, 30, 10, 25, 50, 70, 10, 40, 60, 90, 120, 50, 150, 3000, 1200, 12000, 1 };

        //
        // Templates note working for me
        //

...
namespace CnV
{
	...
	public partial class AGame:Microsoft.Xna.Framework.Game
	{
		...
		public static EffectPass GetTileEffect() => (wantLighting) ? litEffect : unlitEffect;

		///		public static bool wantLighting => ;
		public static bool wantShadow => wantLighting;
			...
			set {
				...
				if(City.myCities.Any())
				{
					...
					if(continent != activeContinent)
					{
						...
						{
							if(city.packedContinent == continent)
							{

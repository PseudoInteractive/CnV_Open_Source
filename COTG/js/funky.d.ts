...
declare function openAttackSender(args: string): void;
declare function Aimp(str: any): void;
...
declare function getFormattedTime(date_2: Date): string;
